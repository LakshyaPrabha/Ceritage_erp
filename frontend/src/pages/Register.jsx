            ...
            {[1,2].map((s) => (
              <div key={s} style={{ display:"flex", alignItems:"center", gap:8 }}>
                <div style={{
                  ...
                  background: step >= s ? "linear-gradient(135deg,#3B55E6,#8B3BC8)" : t.inputBg,
                ...
                <div style={{ position:"relative" }}>
                  <input
                    style={{
                      ...inputStyle,
                      paddingRight:60,
                      borderColor: form.confirm && form.confirm !== form.password ? "rgba(230,59,138,0.5)" : t.inputBorder,
                    }}
          ...
          <form onSubmit={handleSubmit} noValidate>
            ...
            <div style={{ display:"flex", gap:10 }}>
              ...
              <button
                ...
                style={{
                  flex:2, padding:13,
                  background: loading ? "rgba(139,59,200,0.4)" : "linear-gradient(135deg,#3B55E6,#8B3BC8)",
                  border:"none", borderRadius:11, color:"#fff",
